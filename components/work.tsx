        ...
        <div className="flex flex-col gap-10 md:gap-14">
          {projects.map((project, index) => (
            <motion.article
              key={project.title}
              variants={item}
              className="group grid overflow-hidden rounded-3xl bg-bg-secondary shadow-xl shadow-accent/10 transition-shadow duration-200 hover:shadow-xl hover:shadow-accent/20 lg:grid-cols-[1.2fr_0.8fr]"
            >
              <div className="relative min-h-64 overflow-hidden sm:min-h-80 lg:min-h-[28rem]">
                ...
                <div className="pointer-events-none absolute inset-0 bg-black/40 transition-opacity duration-250 ease-out group-hover:opacity-0 group-focus-within:opacity-0" />
                ...
                <div className="absolute right-5 top-5 flex flex-wrap justify-end gap-2 transition-[transform,opacity] duration-200 ease-out sm:pointer-events-none sm:translate-y-1 sm:opacity-0 sm:group-hover:pointer-events-auto sm:group-hover:translate-y-0 sm:group-hover:opacity-100 sm:group-focus-within:pointer-events-auto sm:group-focus-within:translate-y-0 sm:group-focus-within:opacity-100">
                  {project.liveLink && (
                    <a
              ...
              <div className="relative flex flex-col justify-between p-7 sm:p-9 lg:p-12">
                <div>
                  <h4 className="mb-4 text-3xl font-semibold tracking-tight text-text-primary transition-colors duration-200 group-hover:text-accent-hover md:text-4xl">
                    {project.title}
                  </h4>
                  {project.description && (
